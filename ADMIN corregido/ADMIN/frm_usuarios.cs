...
namespace ADMIN
{
    public partial class frm_usuarios : Form
    {
        ...
        private void actualizar()
        {
            ...
            try
            {
                string sql = string.Format("SELECT USU_USUARIO, MD5(PASS_USUARIO), PRIVILEGIO_USUARIO FROM USUARIO;");
            ...
            if (Txt_gestionUsuario.Text != "" && Txt_gestionPass.Text != "" && Cmb_gestionPrivilegios.Text != "")
            {
                ...
                try
                {
                    ...
                    if (!reader.Read())
                    {
                        ...
                        sql = string.Format("INSERT INTO USUARIO VALUES('{0}',MD5('{1}'),{2});", Txt_gestionUsuario.Text, Txt_gestionPass.Text, nivel);
            ...
            if (textBox1.Text != "" && textBox2.Text != "" && comboBox1.Text != "")
            {
                ...
                try
                {
                    ...
                    if (!reader.Read() || (textBox3.Text == textBox1.Text))
                    {
                        ...
                        sql = string.Format("UPDATE USUARIO SET USU_USUARIO = '{0}', PASS_USUARIO = MD5('{1}'), PRIVILEGIO_USUARIO = {2} WHERE USU_USUARIO = '{3}';", textBox1.Text, textBox2.Text, nivel, textBox3.Text);
                        cmd = new OdbcCommand(sql, conexion);
                        cmd.ExecuteNonQuery();
