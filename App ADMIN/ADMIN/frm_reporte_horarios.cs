...
namespace ADMIN
{
    public partial class frm_reporte_horarios : Form
    {
        frm_reportes reporte;
        public frm_reporte_horarios(frm_reportes anterior, bool[] privilegios)
        {
            InitializeComponent();
            reporte = anterior;
        }
        ...
        private void To_pdf()
        {
            ...
            if (filename.Trim() != "")
            {
                ...
                doc.Open();
                string remito = "AUTORIZÓ: JULIO TÁNCHEZ";
                string envio = "FECHA:" + DateTime.Now.ToString();
                Chunk chunk = new Chunk("REPORTE DE HORARIOS CINEMA LICAS", FontFactory.GetFont("ARIAL", 20, iTextSharp.text.Font.BOLD));
        ...
        private void frm_reporte_horarios_Load(object sender, EventArgs e)
        {
        ...
        private void frm_reporte_horarios_FormClosing(object sender, FormClosingEventArgs e)
        {
            reporte.Show();
        }
    }
