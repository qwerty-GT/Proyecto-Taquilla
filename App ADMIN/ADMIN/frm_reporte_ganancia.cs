...
namespace ADMIN
{
    public partial class frm_reporte_ganancia : Form
    {
        frm_reportes reporte;
        public frm_reporte_ganancia(frm_reportes anterior, bool[] privilegios)
        {
            InitializeComponent();
            reporte = anterior;
        ...
        private void frm_reporte_ganancia_FormClosing(object sender, FormClosingEventArgs e)
        {
            reporte.Show();
        }
    }
